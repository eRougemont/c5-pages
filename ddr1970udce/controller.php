<?php
namespace Concrete\Package\Ddr1970udce;
...
{
  protected $pkgHandle = 'ddr1970udce';
  protected $pkgVersion = '20.10.01';
  protected $title = 'L’Un et le Divers ou la Cité européenne';
  protected $bookpath = '/livres/ddr1970udce';
