<?php
namespace Concrete\Package\Ddrglaus;
...
{
  protected $pkgHandle = 'ddr_glaus';
  protected $pkgVersion = '21.06.30';
  protected $title = 'Gazette de Lausanne, articles (1940–1984)';
  protected $bookpath = '/articles/glaus';
