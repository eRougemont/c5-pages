<?php
namespace Concrete\Package\Ddr1946lba2;
...
{
  protected $pkgHandle = 'ddr1946lba2';
  protected $pkgVersion = '20.09.28';
  protected $title = 'Lettres sur la bombe atomique';
  protected $bookpath = '/livres/ddr1946lba2';
