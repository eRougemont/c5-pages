<?php
namespace Concrete\Package\Ddr1940mds;
...
{
  protected $pkgHandle = 'ddr1940mds';
  protected $pkgVersion = '21.07.01';
  protected $title = 'Mission ou démission de la Suisse';
  protected $bookpath = '/livres/ddr1940mds';
